...
function Login() {
    ...
    <MDBIcon fab icon="github" size="sm" />
        ...
        <MDBInput wrapperClass="mb-4" label="Nom" id="form1" type="password" />
        <MDBInput
            wrapperClass="mb4"
            label="Identifiant
            " id="form1"
            type="password"
    />
    <MDBInput wrapperClass="mb-4" label="Adresse électronique" id="form1"
        type="email" />
        <MDBInput
        wrapperClass="mb4" label="Mot de
        passe" id="form1"
